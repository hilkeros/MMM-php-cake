...
class MySpaceException extends Exception {
  ...
  public static $MS_DUMP_REQUESTS = '/tmp/ms.error.log';
...
* @access public
*/
  public static $MS_DUMP_REQUESTS = '/tmp/ms.log';
...
/**
  ...
  /**
   * RESTurl: http://api.myspace.com/v1/user
   * Gets the MySpace webUri of the user represented by the token
   *
   * @return String value extracted from the response
   */
